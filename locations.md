...
Depending on the type of resource that you're filtering for, you might be interested in only specific types of location data. For example, if you created a service or VPC infrastructure service, the region and zone codes are used to filter on the Resource list page. However, if you're working with classic infrastructure resources, then the specific data center codes are the pertinent information for you.
